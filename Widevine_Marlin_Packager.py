...
"""
 CONSTANTS
"""
LOG_DIRECTORY = "/opt/scripts/ms3_packager/logs/"
RBM_OUTPUT_PATH = "/opt/scripts/ms3_packager/packaged/"
TS2Encrypt_Binary = "\"/opt/scripts/ms3_packager/bin/Ts2Encrypt\""
MS3_INJECTOR_URL = "https:///ms3/bt/insert.php"
MAX_HTTP_RETRIES = 3
serviceID = "1234"
...
def main():
    try:
        ...
        epilog="USAGE:  MarlinPackager.py  --contentID \"123456789\"" + \
        ...
        for asset in args.assets:
            ...
            target_file = "".join(RBM_OUTPUT_PATH + asset)
